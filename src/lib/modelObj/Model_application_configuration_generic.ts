...
/**
  generic conf
*/
export class Model_application_configuration_generic extends   Model_application_configuration_web   implements Interface.Iapplication_configuration_generic {
...
*/
  constructor(obj:any={}){
    ...
    public _class:string  = "application_configuration_generic" ;
      ...
      public static create(target:any, path:string=""):Promise<Model_application_configuration_generic>{
