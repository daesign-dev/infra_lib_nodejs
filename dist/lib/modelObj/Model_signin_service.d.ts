...
*/
export declare class Model_signin_service extends Model_service implements Interface.Isignin_service {
    /**
      service d'enregistrement
    */
    constructor(obj?: any);
...
*/
    ...
    static create(target: any, path?: string): Promise<Model_signin_service>;
}
