...
exports.Model_signin_service = void 0;
const _ = require("lodash");
const Model_service_1 = require("./Model_service");
/**
  service d'enregistrement
*/
class Model_signin_service extends Model_service_1.Model_service {
    /**
      service d'enregistrement
    */
    constructor(obj = {}) {
        super(obj);
        this._class = "signin_service";
    ...
    static create(target, path = "") {
        return Model_signin_service.check(target, true, path).then(() => {
            return new Model_signin_service(target);
        });
    }
}
exports.Model_signin_service = Model_signin_service;
//# sourceMappingURL=Model_signin_service.js.map