...
*/
export class Model_activation_map extends  Base  implements Interface.Iactivation_map {
...
*/
  constructor(obj:any={}){
    ...
    public _class:string  = "activation_map" ;
      ...
      public static create(target:any, path:string=""):Promise<Model_activation_map>{
