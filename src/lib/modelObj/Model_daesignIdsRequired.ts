...
*/
export class Model_daesignIdsRequired extends  Base  implements Interface.IdaesignIdsRequired {
...
*/
  constructor(obj:any={}){
    ...
    public _class:string  = "daesignIdsRequired" ;

        
              /**
        The daesign EndClient ID
        */
               public "daesignEndClientId":string ;
              
       
              /**
        The infra admin application instance ID
        */
               public "infraAdminInstanceId":string ;
              
       
              /**
        The nathan EndClient ID
        */
               public "nathanEndClientId":string ;
        ...
        */
               public "revizQuizInstanceId":string ;
              
       
              /**
        The ID of NginxMultiConfigurator service
        */
               public "serviceNginxMultiConfiguratorId":string ;
              
       
              /**
        The serviceMailToInfraSavvyId
        */
               public "serviceMailToInfraSavvyId":string ;
              
       
              /**
        The identifier of the super administrator endclient
        */
               public "superAdminEndclientId":string ;
              
       
              /**
        The identifier of the super administrator application instance
        */
               public "superAdminApplicationInstanceId":string ;
              
       
              /**
        The Daesign savvy author admin instance ID
        */
               public "daesignSavvyAuthorAdminInstanceId":string ;
      ...
      public static create(target:any, path:string=""):Promise<Model_daesignIdsRequired>{
