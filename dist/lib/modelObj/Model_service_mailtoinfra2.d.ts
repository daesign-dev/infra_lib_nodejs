...
*/
export declare class Model_service_mailtoinfra2 extends Model_service implements Interface.Iservice_mailtoinfra2 {
    /**
      retrouve la configuration de connection de l'app savy a partir du mail de l'utilisateur
    */
    constructor(obj?: any);
...
*/
    ...
    static create(target: any, path?: string): Promise<Model_service_mailtoinfra2>;
}
