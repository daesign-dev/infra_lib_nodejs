...
exports.Model_application_configuration_adaptivmath_student = void 0;
...
/**
  generic conf
*/
class Model_application_configuration_adaptivmath_student extends Model_application_configuration_web_1.Model_application_configuration_web {
    /**
      generic conf
    */
    constructor(obj = {}) {
        super(obj);
        this._class = "application_configuration_adaptivmath_student";
        /**
  use data from author
  */
        this["useDataFromAuthor"] = false;
        ...
        if (obj["useDataFromAuthor"] != undefined) {
            this["useDataFromAuthor"] = new Boolean(obj["useDataFromAuthor"]).valueOf();
        }
    }
    static check(target, isCompleteObj = true, path = "") {
        return super.check(target, isCompleteObj, path)
            ...
            if (target["useDataFromAuthor"] != null && target["useDataFromAuthor"] != undefined) {
                let _useDataFromAuthor = target["useDataFromAuthor"];
                if (!_.isBoolean(_useDataFromAuthor)) {
                    throw new Error(path + "useDataFromAuthor is not a boolean");
                }
            }
    ...
    static create(target, path = "") {
        return Model_application_configuration_adaptivmath_student.check(target, true, path).then(() => {
            return new Model_application_configuration_adaptivmath_student(target);
        });
    }
}
exports.Model_application_configuration_adaptivmath_student = Model_application_configuration_adaptivmath_student;
//# sourceMappingURL=Model_application_configuration_adaptivmath_student.js.map