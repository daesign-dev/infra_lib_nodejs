...
/**
  generic conf
*/
export class Model_application_configuration_adaptivmath_student extends   Model_application_configuration_web   implements Interface.Iapplication_configuration_adaptivmath_student {
...
*/
  constructor(obj:any={}){
    ...
    public _class:string  = "application_configuration_adaptivmath_student" ;
        ...
        */
               public "useDataFromAuthor"?:boolean =false;
      ...
      public static create(target:any, path:string=""):Promise<Model_application_configuration_adaptivmath_student>{
